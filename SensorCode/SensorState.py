...
class SensorState:
    ...
    def makeDummy(self) -> None:
        size = 50
        self.lidar = [[i, 0] for i in range(size)]
        self.terabee_top = [i for i in range(size)]
        self.terabee_mid = [i for i in range(size)]
        self.terabee_bot = [i for i in range(size)]
        self.imu_array = [i for i in range(size)]
        self.heading_arr = [0,0,0]
        self.imu_count = 360
        self.heading = 0
